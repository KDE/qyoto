...
namespace Qyoto {
    ...
    public class QStackedLayout : QLayout, IDisposable {
        ...
        public event SlotFunc<int> SignalWidgetRemoved {
            add { QObject.Connect(this, SIGNAL("widgetRemoved(int)"), value); }
            remove { QObject.Disconnect(this, SIGNAL("widgetRemoved(int)"), value); }
        }
