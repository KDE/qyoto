...
namespace Qyoto {
    ...
    public class QGraphicsPathItem : QAbstractGraphicsShapeItem, IDisposable {
        ...
        public QGraphicsPathItem(IQGraphicsItem parent, QGraphicsScene scene) : this((Type) null) {
            CreateProxy();
            interceptor.Invoke("QGraphicsPathItem##", "QGraphicsPathItem(QGraphicsItem*, QGraphicsScene*)", typeof(void), typeof(IQGraphicsItem), parent, typeof(QGraphicsScene), scene);
        }
        public QGraphicsPathItem(IQGraphicsItem parent) : this((Type) null) {
            CreateProxy();
            interceptor.Invoke("QGraphicsPathItem#", "QGraphicsPathItem(QGraphicsItem*)", typeof(void), typeof(IQGraphicsItem), parent);
        }
