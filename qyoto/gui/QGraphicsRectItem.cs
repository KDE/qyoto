...
namespace Qyoto {
    ...
    public class QGraphicsRectItem : QAbstractGraphicsShapeItem, IDisposable {
        ...
        public QGraphicsRectItem(IQGraphicsItem parent, QGraphicsScene scene) : this((Type) null) {
            CreateProxy();
            interceptor.Invoke("QGraphicsRectItem##", "QGraphicsRectItem(QGraphicsItem*, QGraphicsScene*)", typeof(void), typeof(IQGraphicsItem), parent, typeof(QGraphicsScene), scene);
        }
        public QGraphicsRectItem(IQGraphicsItem parent) : this((Type) null) {
            CreateProxy();
            interceptor.Invoke("QGraphicsRectItem#", "QGraphicsRectItem(QGraphicsItem*)", typeof(void), typeof(IQGraphicsItem), parent);
        }
        ...
        public QGraphicsRectItem(QRectF rect, IQGraphicsItem parent) : this((Type) null) {
            CreateProxy();
            interceptor.Invoke("QGraphicsRectItem##", "QGraphicsRectItem(const QRectF&, QGraphicsItem*)", typeof(void), typeof(QRectF), rect, typeof(IQGraphicsItem), parent);
        }
        ...
        public QGraphicsRectItem(double x, double y, double w, double h, IQGraphicsItem parent) : this((Type) null) {
            CreateProxy();
            interceptor.Invoke("QGraphicsRectItem$$$$#", "QGraphicsRectItem(qreal, qreal, qreal, qreal, QGraphicsItem*)", typeof(void), typeof(double), x, typeof(double), y, typeof(double), w, typeof(double), h, typeof(IQGraphicsItem), parent);
        }
