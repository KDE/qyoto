...
namespace Qyoto {
	...
	public class QGraphicsLinearLayout : QGraphicsLayout, IDisposable {
		...
		public QGraphicsLinearLayout(QGraphicsLayoutItem parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("QGraphicsLinearLayout#", "QGraphicsLinearLayout(QGraphicsLayoutItem*)", typeof(void), typeof(QGraphicsLayoutItem), parent);
		}
		public QGraphicsLinearLayout() : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("QGraphicsLinearLayout", "QGraphicsLinearLayout()", typeof(void));
		}
		public QGraphicsLinearLayout(Qt.Orientation orientation, QGraphicsLayoutItem parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("QGraphicsLinearLayout$#", "QGraphicsLinearLayout(Qt::Orientation, QGraphicsLayoutItem*)", typeof(void), typeof(Qt.Orientation), orientation, typeof(QGraphicsLayoutItem), parent);
		}
		...
		public void AddItem(QGraphicsLayoutItem item) {
			interceptor.Invoke("addItem#", "addItem(QGraphicsLayoutItem*)", typeof(void), typeof(QGraphicsLayoutItem), item);
		}
		...
		public int StretchFactor(QGraphicsLayoutItem item) {
			return (int) interceptor.Invoke("stretchFactor#", "stretchFactor(QGraphicsLayoutItem*) const", typeof(int), typeof(QGraphicsLayoutItem), item);
		}
