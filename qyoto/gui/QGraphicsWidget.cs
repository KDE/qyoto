...
namespace Qyoto {
	...
	public class QGraphicsWidget : QObject, IQGraphicsItem, IQGraphicsLayoutItem, IDisposable {
		...
		public QGraphicsWidget(QGraphicsItem parent, uint wFlags) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("QGraphicsWidget#$", "QGraphicsWidget(QGraphicsItem*, Qt::WindowFlags)", typeof(void), typeof(QGraphicsItem), parent, typeof(uint), wFlags);
		}
		public QGraphicsWidget(QGraphicsItem parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("QGraphicsWidget#", "QGraphicsWidget(QGraphicsItem*)", typeof(void), typeof(QGraphicsItem), parent);
		}
