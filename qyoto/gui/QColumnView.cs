...
namespace Qyoto {
    ...
    public class QColumnView : QAbstractItemView, IDisposable {
        ...
        public event SlotFunc<QModelIndex> SignalUpdatePreviewWidget {
            add { QObject.Connect(this, SIGNAL("updatePreviewWidget(QModelIndex)"), value); }
            remove { QObject.Disconnect(this, SIGNAL("updatePreviewWidget(QModelIndex)"), value); }
        }
