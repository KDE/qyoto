...
namespace Qyoto {
	...
	public class QGraphicsProxyWidget : QGraphicsWidget, IDisposable {
		...
		public QGraphicsProxyWidget(QGraphicsItem parent, uint wFlags) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("QGraphicsProxyWidget#$", "QGraphicsProxyWidget(QGraphicsItem*, Qt::WindowFlags)", typeof(void), typeof(QGraphicsItem), parent, typeof(uint), wFlags);
		}
		public QGraphicsProxyWidget(QGraphicsItem parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("QGraphicsProxyWidget#", "QGraphicsProxyWidget(QGraphicsItem*)", typeof(void), typeof(QGraphicsItem), parent);
		}
