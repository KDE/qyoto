...
namespace Qyoto {
	...
	public class QStandardItem : MarshalByRefObject, IDisposable {
		...
		public virtual void SetData(int role, QVariant value) {
			ProxyQStandardItem().SetData(role,value);
		}
		...
		public QColor BackgroundColor() {
			return ProxyQStandardItem().BackgroundColor();
		}
		[SmokeMethod("setBackgroundColor(const QColor&)")]
		public void SetBackgroundColor(QColor backgroundColor) {
			ProxyQStandardItem().SetBackgroundColor(backgroundColor);
		}
		[SmokeMethod("textColor() const")]
		public QColor TextColor() {
			return ProxyQStandardItem().TextColor();
		}
		[SmokeMethod("setTextColor(const QColor&)")]
		public void SetTextColor(QColor textColor) {
			ProxyQStandardItem().SetTextColor(textColor);
		}
		...
		[SmokeMethod("isTopLevelItem() const")]
		public bool IsTopLevelItem() {
			return ProxyQStandardItem().IsTopLevelItem();
		}
