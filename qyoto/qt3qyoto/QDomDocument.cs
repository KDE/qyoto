...
namespace Qt {
	...
	public class QDomDocument : QDomNode, IDisposable {
		...
		[SmokeMethod("setContent(const QCString&, bool, QString*, int*, int*)")]
		...
		[SmokeMethod("setContent(const QCString&, bool, QString*, int*)")]
		...
		[SmokeMethod("setContent(const QCString&, bool, QString*)")]
		...
		[SmokeMethod("setContent(const QCString&, bool)")]
		...
		[SmokeMethod("setContent(const QCString&, QString*, int*, int*)")]
		...
		[SmokeMethod("setContent(const QCString&, QString*, int*)")]
		...
		public new bool IsDocument() {
			return ProxyQDomDocument().IsDocument();
		}
		...
		public string ToCString() {
			return ProxyQDomDocument().ToCString();
		}
		[SmokeMethod("toCString(int) const")]
		public string ToCString(int arg1) {
			return ProxyQDomDocument().ToCString(arg1);
		}
		~QDomDocument() {
			DisposeQDomDocument();
		}
