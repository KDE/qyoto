...
namespace Kimono {
	...
	/// <remarks> See <see cref="IKFilePreviewSignals"></see> for signals emitted by KFilePreview
	/// </remarks>

	[SmokeClass("KFilePreview")]
	public class KFilePreview : QSplitter, IKFileView, IDisposable {
 		protected KFilePreview(Type dummy) : base((Type) null) {}
		protected new void CreateProxy() {
			interceptor = new SmokeInvocation(typeof(KFilePreview), this);
		}
		private static SmokeInvocation staticInterceptor = null;
		static KFilePreview() {
			staticInterceptor = new SmokeInvocation(typeof(KFilePreview), null);
		}
		public KFilePreview(QWidget parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("KFilePreview#", "KFilePreview(QWidget*)", typeof(void), typeof(QWidget), parent);
		}
		public KFilePreview(KFileView view, QWidget parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("KFilePreview##", "KFilePreview(KFileView*, QWidget*)", typeof(void), typeof(KFileView), view, typeof(QWidget), parent);
		}
		[SmokeMethod("widget()")]
		...
		///      </remarks>		<short>    Delets the current view and sets the view to the given <code>view.</code></short>
		public void SetFileView(KFileView view) {
			interceptor.Invoke("setFileView#", "setFileView(KFileView*)", typeof(void), typeof(KFileView), view);
		}
		/// <remarks>
		/// </remarks>		<return> the current fileview
		///      </return>
		/// 		<short>   </short>
		public KFileView FileView() {
			return (KFileView) interceptor.Invoke("fileView", "fileView() const", typeof(KFileView));
		}
		...
		public virtual void InsertItem(KFileItem arg1) {
			interceptor.Invoke("insertItem#", "insertItem(KFileItem*)", typeof(void), typeof(KFileItem), arg1);
		}
		[SmokeMethod("clear()")]
		...
		///  object of its own.
		///      </remarks>		<short>    This overrides KFileView.ActionCollection() by returning  the actionCollection() of the KFileView (member left) it contains.</short>
		...
		public void SetPreviewWidget(QWidget w, KUrl u) {
			interceptor.Invoke("setPreviewWidget##", "setPreviewWidget(const QWidget*, const KUrl&)", typeof(void), typeof(QWidget), w, typeof(KUrl), u);
		}
		[Q_SLOT("void slotHighlighted(const KFileItem*)")]
		[SmokeMethod("slotHighlighted(const KFileItem*)")]
		protected virtual void SlotHighlighted(KFileItem arg1) {
			interceptor.Invoke("slotHighlighted#", "slotHighlighted(const KFileItem*)", typeof(void), typeof(KFileItem), arg1);
		}
		~KFilePreview() {
			interceptor.Invoke("~KFilePreview", "~KFilePreview()", typeof(void));
		}
		...
		protected new IKFilePreviewSignals Emit {
			get { return (IKFilePreviewSignals) Q_EMIT; }
		}
	}

	public interface IKFilePreviewSignals : IQSplitterSignals {
		[Q_SIGNAL("void showPreview(const KUrl&)")]
		void ShowPreview(KUrl arg1);
		[Q_SIGNAL("void clearPreview()")]
		void ClearPreview();
	}
}
