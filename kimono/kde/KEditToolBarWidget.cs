...
namespace Kimono {
	...
	///  See <see cref="IKEditToolBarWidgetSignals"></see> for signals emitted by KEditToolBarWidget
	/// </remarks>		<author> Kurt Granroth <granroth@kde.org>
	///  </author>
	/// 		<short> A widget used to customize or configure toolbars.</short>

	[SmokeClass("KEditToolBarWidget")]
	public class KEditToolBarWidget : QWidget, IKXMLGUIClient, IDisposable {
 		protected KEditToolBarWidget(Type dummy) : base((Type) null) {}
		protected new void CreateProxy() {
			interceptor = new SmokeInvocation(typeof(KEditToolBarWidget), this);
		}
		...
		/// </param><param> name="xmlfile" The application's local resource file
		/// </param><param> name="global" If true, then the global resource file will also
		///                be parsed
		/// </param><param> name="parent" This widget's parent
		///    </param></remarks>		<short>    Constructor.</short>
		public KEditToolBarWidget(KActionCollection collection, QWidget parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("KEditToolBarWidget##", "KEditToolBarWidget(KActionCollection*, QWidget*)", typeof(void), typeof(KActionCollection), collection, typeof(QWidget), parent);
		}
		public KEditToolBarWidget(KActionCollection collection) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("KEditToolBarWidget#", "KEditToolBarWidget(KActionCollection*)", typeof(void), typeof(KActionCollection), collection);
		}
		/// <remarks>
		...
		public KEditToolBarWidget(QWidget parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("KEditToolBarWidget#", "KEditToolBarWidget(QWidget*)", typeof(void), typeof(QWidget), parent);
		}
		public KEditToolBarWidget() : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("KEditToolBarWidget", "KEditToolBarWidget()", typeof(void));
		}
		/// <remarks>
		///  Loads the toolbar configuration into the widget. Should be called before being shown.
		/// </remarks>		<short>    Loads the toolbar configuration into the widget.</short>
		/// 		<see> KEditToolBar</see>
		public void Load(string resourceFile, bool global, string defaultToolBar) {
			interceptor.Invoke("load$$$", "load(const QString&, bool, const QString&)", typeof(void), typeof(string), resourceFile, typeof(bool), global, typeof(string), defaultToolBar);
		}
		public void Load(string resourceFile, bool global) {
			interceptor.Invoke("load$$", "load(const QString&, bool)", typeof(void), typeof(string), resourceFile, typeof(bool), global);
		}
		public void Load(string resourceFile) {
			interceptor.Invoke("load$", "load(const QString&)", typeof(void), typeof(string), resourceFile);
		}
		/// <remarks>
		///  Loads the toolbar configuration into the widget. Should be called before being shown.
		/// </remarks>		<short>    Loads the toolbar configuration into the widget.</short>
		/// 		<see> KEditToolBar</see>
		public void Load(KXMLGUIFactory factory, string defaultToolBar) {
			interceptor.Invoke("load#$", "load(KXMLGUIFactory*, const QString&)", typeof(void), typeof(KXMLGUIFactory), factory, typeof(string), defaultToolBar);
		}
		public void Load(KXMLGUIFactory factory) {
			interceptor.Invoke("load#", "load(KXMLGUIFactory*)", typeof(void), typeof(KXMLGUIFactory), factory);
		}
		/// <remarks>
		///    </remarks>		<short>   </short>
		...
		/// </remarks>		<return> The status of whether or not the save succeeded.
		///    </return>
		/// 		<short>    Save any changes the user made.</short>
		public bool Save() {
			return (bool) interceptor.Invoke("save", "save()", typeof(bool));
		}
		/// <remarks>
		///  Remove and readd all KMXLGUIClients to update the GUI
		///    </remarks>		<short>    Remove and readd all KMXLGUIClients to update the GUI    </short>
		public void RebuildKXMLGUIClients() {
			interceptor.Invoke("rebuildKXMLGUIClients", "rebuildKXMLGUIClients()", typeof(void));
		}
		~KEditToolBarWidget() {
			interceptor.Invoke("~KEditToolBarWidget", "~KEditToolBarWidget()", typeof(void));
		}
		...
		protected new IKEditToolBarWidgetSignals Emit {
			get { return (IKEditToolBarWidgetSignals) Q_EMIT; }
		}
	}

	public interface IKEditToolBarWidgetSignals : IQWidgetSignals {
		/// <remarks>
		///  Emitted whenever any modifications are made by the user.
		///    </remarks>		<short>    Emitted whenever any modifications are made by the user.</short>
		[Q_SIGNAL("void enableOk(bool)")]
		void EnableOk(bool arg1);
	}
}
