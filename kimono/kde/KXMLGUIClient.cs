...
namespace Kimono {
    ...
    public interface IKXMLGUIClient {
        ...
        IKXMLGUIClient ParentClient();
        void InsertChildClient(IKXMLGUIClient child);
        void RemoveChildClient(IKXMLGUIClient child);
        List<KXMLGUIClient> ChildClients();
        void SetClientBuilder(IKXMLGUIBuilder builder);
        IKXMLGUIBuilder ClientBuilder();
        void ReloadXML();
    ...
    public class KXMLGUIClient : Object, IKXMLGUIClient, IDisposable {
        ...
        ///    </remarks>        <short>    Constructs a KXMLGUIClient which can be used with a KXMLGUIFactory  to create a GUI from actions and an XML document,  and which can be dynamically merged with other KXMLGUIClients.</short>
        public KXMLGUIClient(IKXMLGUIClient parent) : this((Type) null) {
            CreateProxy();
