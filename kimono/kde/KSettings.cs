...
namespace Kimono {
	...
	public class KSettings : Object {
		...
		/// </remarks>		<short>     Dialog for selecting which plugins should be active for an application.</short>

		[SmokeClass("KSettings::ComponentsDialog")]
		public class ComponentsDialog : KDialog, IDisposable {
	 		protected ComponentsDialog(Type dummy) : base((Type) null) {}
			protected new void CreateProxy() {
				interceptor = new SmokeInvocation(typeof(ComponentsDialog), this);
			}
			// void setPluginInfos(const QMap<QString, KPluginInfo*>& arg1); >>>> NOT CONVERTED
			/// <remarks>
			///           Create Dialog.
			/// <param> name="parent" parent widget
			/// </param><param> name="name" name
			///         </param></remarks>		<short>             Create Dialog.</short>
			public ComponentsDialog(QWidget parent, string name) : this((Type) null) {
				CreateProxy();
				interceptor.Invoke("ComponentsDialog#$", "ComponentsDialog(QWidget*, const char*)", typeof(void), typeof(QWidget), parent, typeof(string), name);
			}
			public ComponentsDialog(QWidget parent) : this((Type) null) {
				CreateProxy();
				interceptor.Invoke("ComponentsDialog#", "ComponentsDialog(QWidget*)", typeof(void), typeof(QWidget), parent);
			}
			public ComponentsDialog() : this((Type) null) {
				CreateProxy();
				interceptor.Invoke("ComponentsDialog", "ComponentsDialog()", typeof(void));
			}
			/// <remarks>
			///           Add a plugin that the dialog offers for selection.
			///         </remarks>		<short>             Add a plugin that the dialog offers for selection.</short>
			public void AddPluginInfo(KPluginInfo arg1) {
				interceptor.Invoke("addPluginInfo#", "addPluginInfo(KPluginInfo*)", typeof(void), typeof(KPluginInfo), arg1);
			}
			/// <remarks>
			///           Set list of plugins the dialog offers for selection. (Overwrites a previous list)
			///         </remarks>		<short>             Set list of plugins the dialog offers for selection.</short>
			/// <remarks>
			///           Set list of plugins the dialog offers for selection. (Overwrites a previous list)
			///         </remarks>		<short>             Set list of plugins the dialog offers for selection.</short>
			public void SetPluginInfos(List<KPluginInfo> plugins) {
				interceptor.Invoke("setPluginInfos?", "setPluginInfos(const QList<KPluginInfo*>&)", typeof(void), typeof(List<KPluginInfo>), plugins);
			}
			/// <remarks>
			///  reimplemented
			...
			protected new IComponentsDialogSignals Emit {
				get { return (IComponentsDialogSignals) Q_EMIT; }
			}
		}

		public interface IComponentsDialogSignals : IKDialogSignals {
		}
	}
}
