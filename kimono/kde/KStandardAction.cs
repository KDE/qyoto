...
namespace Kimono {
	...
	public class KStandardAction : Object {
		...
		public enum StandardAction {
			...
			AboutKDE = 57,
			TipofDay = 58,
			ConfigureNotifications = 59,
			FullScreen = 60,
			Clear = 61,
			PasteText = 62,
			SwitchApplicationLanguage = 63,
		}
		/// <remarks>
		...
		public static string StdName(KStandardAction.StandardAction act_enum) {
			return (string) staticInterceptor.Invoke("stdName$", "stdName(KStandardAction::StandardAction)", typeof(string), typeof(KStandardAction.StandardAction), act_enum);
		}
		/// <remarks>
