...
namespace Kimono {
	...
	/// <remarks>
	///  This class represents one preferences setting as used by <see cref="KConfigSkeleton"></see>.
	...
	public abstract class KConfigSkeletonItem : Object {
		...
		/// <remarks>
		///  This function is called by <see cref="KConfigSkeleton"></see> to read the value for this setting
		///  from a config file.
		///      </remarks>		<short>    This function is called by @ref KConfigSkeleton to read the value for this setting  from a config file.</short>
		[SmokeMethod("readConfig(KConfig*)")]
		public abstract void ReadConfig(KConfig arg1);
		/// <remarks>
		///  This function is called by <see cref="KConfigSkeleton"></see> to write the value of this setting
		///  to a config file.
		///      </remarks>		<short>    This function is called by @ref KConfigSkeleton to write the value of this setting  to a config file.</short>
		...
		///      </remarks>		<short>    Exchanges the current value with the default value  Used by KConfigSkeleton.UseDefaults(bool);      </short>
