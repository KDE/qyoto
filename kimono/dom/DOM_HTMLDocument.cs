...
namespace Kimono {
	...
	public class HTMLDocument : DOM.Document, IDisposable {
		...
		public string Cookie() {
			return (string) interceptor.Invoke("cookie", "cookie() const", typeof(string));
		}
		/// <remarks>
		///  see cookie
		///      </remarks>		<short>    see cookie      </short>
		public void SetCookie(string arg1) {
			interceptor.Invoke("setCookie#", "setCookie(const DOM::DOMString&)", typeof(void), typeof(string), arg1);
		}
		/// <remarks>
		...
		public void Write(string text) {
			interceptor.Invoke("write#", "write(const DOM::DOMString&)", typeof(void), typeof(string), text);
		}
		/// <remarks>
		...
		public void Writeln(string text) {
			interceptor.Invoke("writeln#", "writeln(const DOM::DOMString&)", typeof(void), typeof(string), text);
		}
		/// <remarks>
		...
		public DOM.NodeList GetElementsByName(string elementName) {
			return (DOM.NodeList) interceptor.Invoke("getElementsByName#", "getElementsByName(const DOM::DOMString&)", typeof(DOM.NodeList), typeof(string), elementName);
		}
		/// <remarks>
		///  not part of the DOM
		...
		public string CompleteURL(string url) {
			return (string) interceptor.Invoke("completeURL#", "completeURL(const DOM::DOMString&) const", typeof(string), typeof(string), url);
		}
		/// <remarks>
		///  Not part of the DOM
		...
		public string LastModified() {
			return (string) interceptor.Invoke("lastModified", "lastModified() const", typeof(string));
		}
		/// <remarks>
		///  Not part of the DOM
