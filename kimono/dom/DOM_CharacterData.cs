...
namespace Kimono {
	...
	public class CharacterData : DOM.Node, IDisposable {
		...
		public string SubstringData(ulong offset, ulong count) {
			return (string) interceptor.Invoke("substringData$$", "substringData(const unsigned long, const unsigned long)", typeof(string), typeof(ulong), offset, typeof(ulong), count);
		}
		/// <remarks>
		...
		public void AppendData(string arg) {
			interceptor.Invoke("appendData#", "appendData(const DOM::DOMString&)", typeof(void), typeof(string), arg);
		}
		/// <remarks>
		...
		public void InsertData(ulong offset, string arg) {
			interceptor.Invoke("insertData$#", "insertData(const unsigned long, const DOM::DOMString&)", typeof(void), typeof(ulong), offset, typeof(string), arg);
		}
		/// <remarks>
		...
		public void ReplaceData(ulong offset, ulong count, string arg) {
			interceptor.Invoke("replaceData$$#", "replaceData(const unsigned long, const unsigned long, const DOM::DOMString&)", typeof(void), typeof(ulong), offset, typeof(ulong), count, typeof(string), arg);
		}
		~CharacterData() {
			interceptor.Invoke("~CharacterData", "~CharacterData()", typeof(void));
		}
