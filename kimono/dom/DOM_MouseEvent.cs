...
namespace Kimono {
	...
	public class MouseEvent : DOM.UIEvent {
		...
		public void InitMouseEvent(string typeArg, bool canBubbleArg, bool cancelableArg, DOM.AbstractView viewArg, long detailArg, long screenXArg, long screenYArg, long clientXArg, long clientYArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg, ushort buttonArg, DOM.Node relatedTargetArg) {
			interceptor.Invoke("initMouseEvent#$$#$$$$$$$$$$#", "initMouseEvent(const DOM::DOMString&, bool, bool, const DOM::AbstractView&, long, long, long, long, long, bool, bool, bool, bool, unsigned short, const DOM::Node&)", typeof(void), typeof(string), typeArg, typeof(bool), canBubbleArg, typeof(bool), cancelableArg, typeof(DOM.AbstractView), viewArg, typeof(long), detailArg, typeof(long), screenXArg, typeof(long), screenYArg, typeof(long), clientXArg, typeof(long), clientYArg, typeof(bool), ctrlKeyArg, typeof(bool), altKeyArg, typeof(bool), shiftKeyArg, typeof(bool), metaKeyArg, typeof(ushort), buttonArg, typeof(DOM.Node), relatedTargetArg);
		}
	}
	}
}
