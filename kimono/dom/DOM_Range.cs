...
namespace Kimono {
	...
	public class Range : Object, IDisposable {
		...
		public string ToHTML() {
			return (string) interceptor.Invoke("toHTML", "toHTML()", typeof(string));
		}
		public DOM.DocumentFragment CreateContextualFragment(string html) {
			return (DOM.DocumentFragment) interceptor.Invoke("createContextualFragment#", "createContextualFragment(const DOM::DOMString&)", typeof(DOM.DocumentFragment), typeof(string), html);
		}
		/// <remarks>
