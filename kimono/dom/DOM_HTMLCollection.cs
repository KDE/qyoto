...
namespace Kimono {
	...
	public class HTMLCollection : Object, IDisposable {
		...
		public DOM.Node NamedItem(string name) {
			return (DOM.Node) interceptor.Invoke("namedItem#", "namedItem(const DOM::DOMString&) const", typeof(DOM.Node), typeof(string), name);
		}
		/// <remarks>
		///  not part of the DOM
		///      </remarks>		<short>   </short>
		...
		public DOM.Node NextNamedItem(string name) {
			return (DOM.Node) interceptor.Invoke("nextNamedItem#", "nextNamedItem(const DOM::DOMString&) const", typeof(DOM.Node), typeof(string), name);
		}
		~HTMLCollection() {
			interceptor.Invoke("~HTMLCollection", "~HTMLCollection()", typeof(void));
		}
