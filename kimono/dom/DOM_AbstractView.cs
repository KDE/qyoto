...
namespace Kimono {
	...
	public abstract class AbstractView : Object {
		...
		public DOM.CSSStyleDeclaration GetComputedStyle(DOM.Element elt, string pseudoElt) {
			return (DOM.CSSStyleDeclaration) interceptor.Invoke("getComputedStyle##", "getComputedStyle(const DOM::Element&, const DOM::DOMString&)", typeof(DOM.CSSStyleDeclaration), typeof(DOM.Element), elt, typeof(string), pseudoElt);
		}
		public bool IsNull() {
