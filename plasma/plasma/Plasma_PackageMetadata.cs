...
namespace Plasma {
	...
	public class PackageMetadata : Object, IDisposable {
		...
		///      </remarks>		<short>    Set the implementation API string.</short>
		public void SetImplementationApi(string language) {
			interceptor.Invoke("setImplementationApi$", "setImplementationApi(const QString&)", typeof(void), typeof(string), language);
		}
		~PackageMetadata() {
			interceptor.Invoke("~PackageMetadata", "~PackageMetadata()", typeof(void));
		}
