...
namespace Plasma {
	...
	public class AnimationDriver : QObject, IDisposable {
		...
		public virtual void ItemAppear(double progress, QGraphicsItem item) {
			interceptor.Invoke("itemAppear$#", "itemAppear(qreal, QGraphicsItem*)", typeof(void), typeof(double), progress, typeof(QGraphicsItem), item);
		}
		[SmokeMethod("itemDisappear(qreal, QGraphicsItem*)")]
		public virtual void ItemDisappear(double progress, QGraphicsItem item) {
			interceptor.Invoke("itemDisappear$#", "itemDisappear(qreal, QGraphicsItem*)", typeof(void), typeof(double), progress, typeof(QGraphicsItem), item);
		}
		[SmokeMethod("itemActivated(qreal, QGraphicsItem*)")]
		public virtual void ItemActivated(double progress, QGraphicsItem item) {
			interceptor.Invoke("itemActivated$#", "itemActivated(qreal, QGraphicsItem*)", typeof(void), typeof(double), progress, typeof(QGraphicsItem), item);
		}
		[SmokeMethod("itemSlideIn(qreal, QGraphicsItem*, const QPoint&, const QPoint&)")]
		public virtual void ItemSlideIn(double progress, QGraphicsItem item, QPoint start, QPoint destination) {
			interceptor.Invoke("itemSlideIn$###", "itemSlideIn(qreal, QGraphicsItem*, const QPoint&, const QPoint&)", typeof(void), typeof(double), progress, typeof(QGraphicsItem), item, typeof(QPoint), start, typeof(QPoint), destination);
		}
		[SmokeMethod("itemSlideOut(qreal, QGraphicsItem*, const QPoint&, const QPoint&)")]
		public virtual void ItemSlideOut(double progress, QGraphicsItem item, QPoint start, QPoint destination) {
			interceptor.Invoke("itemSlideOut$###", "itemSlideOut(qreal, QGraphicsItem*, const QPoint&, const QPoint&)", typeof(void), typeof(double), progress, typeof(QGraphicsItem), item, typeof(QPoint), start, typeof(QPoint), destination);
		}
		~AnimationDriver() {
			interceptor.Invoke("~AnimationDriver", "~AnimationDriver()", typeof(void));
		}
