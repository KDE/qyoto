...
namespace Plasma {
	...
	public interface IDataContainerSignals : IQObjectSignals {
		...
		[Q_SIGNAL("void dataUpdated(const QString&, const Plasma::DataEngine::Data&)")]
		...
		[Q_SIGNAL("void becameUnused(const QString&)")]
		...
		[Q_SIGNAL("void updateRequested(Plasma::DataContainer*)")]
