...
namespace Plasma {
	...
	public class Package : Object, IDisposable {
		...
		public Package(string packageRoot, string package, Plasma.PackageStructure structure) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("Package$$#", "Package(const QString&, const QString&, Plasma::PackageStructure::Ptr)", typeof(void), typeof(string), packageRoot, typeof(string), package, typeof(Plasma.PackageStructure), structure);
		}
		/// <remarks>
		...
		public Package(string packagePath, Plasma.PackageStructure structure) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("Package$#", "Package(const QString&, Plasma::PackageStructure::Ptr)", typeof(void), typeof(string), packagePath, typeof(Plasma.PackageStructure), structure);
		}
		/// <remarks>
