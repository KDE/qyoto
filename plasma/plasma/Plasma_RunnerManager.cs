...
namespace Plasma {
	...
	public class RunnerManager : QObject, IDisposable {
		...
		[Q_SLOT("void launchQuery(const QString&, const QString&)")]
		...
		[Q_SLOT("void launchQuery(const QString&)")]
		...
		[Q_SLOT("bool execQuery(const QString&, const QString&)")]
		...
		///  Convenience version of above
		///          </remarks>		<short>    Convenience version of above          </short>
		[Q_SLOT("bool execQuery(const QString&)")]
	...
	public interface IRunnerManagerSignals : IQObjectSignals {
		...
		[Q_SIGNAL("void matchesChanged(const QList<Plasma::QueryMatch>&)")]
