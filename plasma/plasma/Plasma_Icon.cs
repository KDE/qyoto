...
namespace Plasma {
	...
	public class Icon : QGraphicsWidget, IDisposable {
		...
		public Icon(QGraphicsItem parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("Icon#", "Icon(QGraphicsItem*)", typeof(void), typeof(QGraphicsItem), parent);
		}
		...
		public Icon(string text, QGraphicsItem parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("Icon$#", "Icon(const QString&, QGraphicsItem*)", typeof(void), typeof(string), text, typeof(QGraphicsItem), parent);
		}
		...
		public Icon(QIcon icon, string text, QGraphicsItem parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("Icon#$#", "Icon(const QIcon&, const QString&, QGraphicsItem*)", typeof(void), typeof(QIcon), icon, typeof(string), text, typeof(QGraphicsItem), parent);
		}
