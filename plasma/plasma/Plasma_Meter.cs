...
namespace Plasma {
	...
	public class Meter : QGraphicsWidget, IDisposable {
		...
		public Meter(QGraphicsItem parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("Meter#", "Meter(QGraphicsItem*)", typeof(void), typeof(QGraphicsItem), parent);
		}
		...
		[Q_SLOT("void dataUpdated(const QString&, const Plasma::DataEngine::Data&)")]
		public void DataUpdated(string sourceName, Dictionary<string, QVariant> data) {
			interceptor.Invoke("dataUpdated$?", "dataUpdated(const QString&, const Plasma::DataEngine::Data&)", typeof(void), typeof(string), sourceName, typeof(Dictionary<string, QVariant>), data);
		}
		/// <remarks>
