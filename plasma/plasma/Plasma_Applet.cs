...
namespace Plasma {
	...
	public class Applet : QGraphicsWidget, IDisposable {
		...
		public Applet(QGraphicsItem parent, string serviceId, uint appletId) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("Applet#$$", "Applet(QGraphicsItem*, const QString&, uint)", typeof(void), typeof(QGraphicsItem), parent, typeof(string), serviceId, typeof(uint), appletId);
		}
		public Applet(QGraphicsItem parent, string serviceId) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("Applet#$", "Applet(QGraphicsItem*, const QString&)", typeof(void), typeof(QGraphicsItem), parent, typeof(string), serviceId);
		}
		public Applet(QGraphicsItem parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("Applet#", "Applet(QGraphicsItem*)", typeof(void), typeof(QGraphicsItem), parent);
		}
		...
		public Applet(QObject parent, List<QVariant> args) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("Applet#?", "Applet(QObject*, const QVariantList&)", typeof(void), typeof(QObject), parent, typeof(List<QVariant>), args);
		}
		/// <remarks>
		...
		protected void RegisterAsDragHandle(QGraphicsItem item) {
			interceptor.Invoke("registerAsDragHandle#", "registerAsDragHandle(QGraphicsItem*)", typeof(void), typeof(QGraphicsItem), item);
		}
		/// <remarks>
		...
		protected void UnregisterAsDragHandle(QGraphicsItem item) {
			interceptor.Invoke("unregisterAsDragHandle#", "unregisterAsDragHandle(QGraphicsItem*)", typeof(void), typeof(QGraphicsItem), item);
		}
		/// <remarks>
		...
		protected bool IsRegisteredAsDragHandle(QGraphicsItem item) {
			return (bool) interceptor.Invoke("isRegisteredAsDragHandle#", "isRegisteredAsDragHandle(QGraphicsItem*)", typeof(bool), typeof(QGraphicsItem), item);
		}
		/// <remarks>
		/// </remarks>		<short>   </short>
		...
		public static Plasma.Applet Load(string name, uint appletId, List<QVariant> args) {
			return (Plasma.Applet) staticInterceptor.Invoke("load$$?", "load(const QString&, uint, const QVariantList&)", typeof(Plasma.Applet), typeof(string), name, typeof(uint), appletId, typeof(List<QVariant>), args);
		}
		...
		public static Plasma.Applet Load(KPluginInfo info, uint appletId, List<QVariant> args) {
			return (Plasma.Applet) staticInterceptor.Invoke("load#$?", "load(const KPluginInfo&, uint, const QVariantList&)", typeof(Plasma.Applet), typeof(KPluginInfo), info, typeof(uint), appletId, typeof(List<QVariant>), args);
		}
