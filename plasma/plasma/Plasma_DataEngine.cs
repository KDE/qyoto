...
namespace Plasma {
	...
	public class DataEngine : QObject, IDisposable {
		...
		public DataEngine(QObject parent, KService service) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("DataEngine##", "DataEngine(QObject*, KService::Ptr)", typeof(void), typeof(QObject), parent, typeof(KService), service);
		}
		...
		public DataEngine(QObject parent, List<QVariant> args) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("DataEngine#?", "DataEngine(QObject*, const QVariantList&)", typeof(void), typeof(QObject), parent, typeof(List<QVariant>), args);
		}
		/// <remarks>
		...
		protected void SetData(string source, Dictionary<string, QVariant> data) {
			interceptor.Invoke("setData$?", "setData(const QString&, const Plasma::DataEngine::Data&)", typeof(void), typeof(string), source, typeof(Dictionary<string, QVariant>), data);
		}
		/// <remarks>
