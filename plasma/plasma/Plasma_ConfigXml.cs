...
namespace Plasma {
	...
	public class ConfigXml : KConfigSkeleton, IDisposable {
		...
		public ConfigXml(KSharedConfig config, QIODevice xml, QObject parent) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("ConfigXml###", "ConfigXml(KSharedConfigPtr, QIODevice*, QObject*)", typeof(void), typeof(KSharedConfig), config, typeof(QIODevice), xml, typeof(QObject), parent);
		}
		public ConfigXml(KSharedConfig config, QIODevice xml) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("ConfigXml##", "ConfigXml(KSharedConfigPtr, QIODevice*)", typeof(void), typeof(KSharedConfig), config, typeof(QIODevice), xml);
		}
		/// <remarks>
		///  Creates a KConfigSkeleton populated using the definition found in
		///  the XML data passed in.
