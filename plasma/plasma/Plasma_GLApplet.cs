...
namespace Plasma {
	...
	public class GLApplet : Plasma.Applet, IDisposable {
		...
		public GLApplet(QGraphicsItem parent, string serviceId, int appletId) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("GLApplet#$$", "GLApplet(QGraphicsItem*, const QString&, int)", typeof(void), typeof(QGraphicsItem), parent, typeof(string), serviceId, typeof(int), appletId);
		}
		/// <remarks>
		...
		public GLApplet(QObject parent, List<QVariant> args) : this((Type) null) {
			CreateProxy();
			interceptor.Invoke("GLApplet#?", "GLApplet(QObject*, const QVariantList&)", typeof(void), typeof(QObject), parent, typeof(List<QVariant>), args);
		}
