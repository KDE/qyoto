...
namespace Plasma {
	...
	public class Corona : QGraphicsScene, IDisposable {
		...
		public Plasma.Containment AddContainment(string name, List<QVariant> args) {
			return (Plasma.Containment) interceptor.Invoke("addContainment$?", "addContainment(const QString&, const QVariantList&)", typeof(Plasma.Containment), typeof(string), name, typeof(List<QVariant>), args);
		}
		...
		[Q_SLOT("void initializeLayout(const QString&)")]
		...
		[Q_SLOT("void loadLayout(const QString&)")]
		...
		[Q_SLOT("void saveLayout(const QString&) const")]
		...
		[Q_SLOT("void destroyContainment(Plasma::Containment*)")]
		...
		///      </return>
		/// 		<short>   </short>
		[Q_SLOT("Plasma::ImmutabilityType immutability() const")]
